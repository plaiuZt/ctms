...
namespace CTMS.Web.Common.Help
{
    public class ReadWikiHepler
    {
        ...
        public void WikiToArticle()
        {
            ...
            string docpath = AppSettingsManager.Get($"PathConfig:InitDocFiles"); // "E:\\GitHub\\FreeSqlCms\\src\\CTMS.Web\\wwwroot\\file\\FreeSql.wiki";
